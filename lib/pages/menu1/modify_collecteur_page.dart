...
class ModifyCollecteurPage extends StatefulWidget {
  Map dataCollecteur;
  ...
  @override
  _ModifyCollecteurPageState createState() => _ModifyCollecteurPageState();
}

class _ModifyCollecteurPageState extends State<ModifyCollecteurPage> {
  //For Modify Collecteur
  ...
  void initState() {
    setState(() {
      _siteCollecteur = widget.dataCollecteur['siteCollecteur'];
      _nomCollecteurController.text = widget.dataCollecteur['nomCollecteur'];
      _prenomCollecteurController.text =
          widget.dataCollecteur['prenomCollecteur'];
      date = DateTime(
          int.parse(widget.dataCollecteur['datedeNaissance'].substring(6)),
          int.parse(widget.dataCollecteur['datedeNaissance'].substring(3, 5)),
          int.parse(widget.dataCollecteur['datedeNaissance'].substring(0, 2)));
    });
    super.initState();
  }
            ...
            children: [
              ...
              RichText(
                text: TextSpan(
                  children: <TextSpan>[
                    TextSpan(
                      text: graphique.languagefr['modify_collecteur_page']
                              ['nom_page'] +
                          ': ' +
                          widget.dataCollecteur['nomCollecteur'] +
                          ' ' +
                          widget.dataCollecteur['prenomCollecteur'],
                      style: TextStyle(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      graphique.languagefr['modify_collecteur_page']
                          ['form_title'],
                      style: TextStyle(
                        color: Color(graphique.color['main_color_2']),
                        fontSize: 17,
                          ...
                          onTap: () async {
                            if (_createCollecteurKeyForm.currentState!
                              ...
                              await _collecteur
                                  .where('idCollecteur',
                                      isEqualTo:
                                          widget.dataCollecteur['idCollecteur'])
                                  .limit(1)
                                  .get()
                                ...
                                querySnapshot.docs.forEach((doc) {
                                  _collecteur.doc(doc.id).update({
                                    ...
                                    print("Collecteur Modified");
                                    Fluttertoast.showToast(
                                        msg: "Collecteur Modified",
