...
class AddContactPartenairePage extends StatefulWidget {
  Map dataPartenaire;
  AddContactPartenairePage({
    Key? key,
    required this.dataPartenaire,
  }) : super(key: key);
  @override
  _AddContactPartenairePageState createState() =>
      _AddContactPartenairePageState();
}
...
class _AddContactPartenairePageState extends State<AddContactPartenairePage> {
  ...
  String idNewContact = '';
  void initState() {
    if (widget.dataPartenaire['idContactPartenaire'] == 'null') {
      setState(() {
        isPrincipal = true;
      });
    } else {
            ...
            children: [
              ...
              RichText(
                text: TextSpan(
                  children: <TextSpan>[
                    TextSpan(
                      text: graphique.languagefr['add_contact_partenaire_page']
                              ['nom_page'] +
                          ': ' +
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      graphique.languagefr['add_contact_partenaire_page']
                          ['form_title'],
                      style: TextStyle(
                        color: Color(graphique.color['main_color_2']),
                        fontSize: 17,
                        ...
                        child: GestureDetector(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                graphique.languagefr[
                                    'add_contact_partenaire_page']['button_2'],
                                style: TextStyle(
                                  color:
                                      Color(graphique.color['default_black']),
                                  fontSize: 15,
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            if (_createContactKeyForm.currentState!
                              ...
                              await _partenaire
                                  .where('idPartenaire',
                                      isEqualTo:
                                          widget.dataPartenaire['idPartenaire'])
                                  .limit(1)
                                  .get()
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                graphique.languagefr[
                                    'add_contact_partenaire_page']['button_1'],
                                style: TextStyle(
                                  color:
                                      Color(graphique.color['default_black']),
                                  fontSize: 15,
